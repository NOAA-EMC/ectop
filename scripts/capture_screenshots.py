...
class MockNode:
    ...
    def get_state(self): return "active"
    def get_generated_variables(self): return []
    def get_trigger(self): return None
    def get_complete(self): return None
    def get_why(self): return "Testing"
